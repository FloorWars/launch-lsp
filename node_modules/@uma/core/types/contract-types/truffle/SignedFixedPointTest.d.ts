...
export interface SignedFixedPointTestContract
  extends Truffle.Contract<SignedFixedPointTestInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<SignedFixedPointTestInstance>;
}

type AllEvents = never;

export interface SignedFixedPointTestInstance extends Truffle.ContractInstance {
  wrapFromSigned(
    a: number | BN | string,
