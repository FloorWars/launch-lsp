...
export interface IUniswapV3PoolImmutablesContract
  extends Truffle.Contract<IUniswapV3PoolImmutablesInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<IUniswapV3PoolImmutablesInstance>;
}

type AllEvents = never;

export interface IUniswapV3PoolImmutablesInstance
