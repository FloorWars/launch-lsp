...
export interface WithdrawableContract
  extends Truffle.Contract<WithdrawableInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<WithdrawableInstance>;
}
...
export interface WithdrawableInstance extends Truffle.ContractInstance {
  /**
