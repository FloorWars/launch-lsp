...
export interface ExpandedIERC20Contract
  extends Truffle.Contract<ExpandedIERC20Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ExpandedIERC20Instance>;
}
...
export interface ExpandedIERC20Instance extends Truffle.ContractInstance {
  /**
