...
export class MultiRoleTest extends Contract {
  ...
  functions: {
    ...
    "createSharedRole(uint256,uint256,address[])"(
      roleId: BigNumberish,
      managingRoleId: BigNumberish,
      initialMembers: string[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "createExclusiveRole(uint256,uint256,address)"(
      roleId: BigNumberish,
      managingRoleId: BigNumberish,
      initialMember: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "revertIfNotHoldingRole(uint256)"(
      roleId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[void]>;
  };
