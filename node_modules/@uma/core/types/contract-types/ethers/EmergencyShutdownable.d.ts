...
interface EmergencyShutdownableInterface extends ethers.utils.Interface {
  functions: {
...
export class EmergencyShutdownable extends Contract {
  ...
  interface: EmergencyShutdownableInterface;
