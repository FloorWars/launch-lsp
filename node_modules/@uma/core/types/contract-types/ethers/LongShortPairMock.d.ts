...
interface LongShortPairMockInterface extends ethers.utils.Interface {
  functions: {
...
export class LongShortPairMock extends Contract {
  ...
  interface: LongShortPairMockInterface;
