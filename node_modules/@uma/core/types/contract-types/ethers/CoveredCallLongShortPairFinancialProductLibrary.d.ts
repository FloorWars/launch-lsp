...
interface CoveredCallLongShortPairFinancialProductLibraryInterface
...
export class CoveredCallLongShortPairFinancialProductLibrary extends Contract {
  ...
  functions: {
    ...
    "longShortPairStrikePrices(address)"(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
