...
interface PerpetualPositionManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class PerpetualPositionManager extends Contract {
  ...
  interface: PerpetualPositionManagerInterface;
