...
export interface DesignatedVotingContract
  extends Truffle.Contract<DesignatedVotingInstance> {
  "new"(
    finderAddress: string,
    ownerAddress: string,
    voterAddress: string,
    meta?: Truffle.TransactionDetails
  ): Promise<DesignatedVotingInstance>;
}
...
export interface DesignatedVotingInstance extends Truffle.ContractInstance {
  /**
