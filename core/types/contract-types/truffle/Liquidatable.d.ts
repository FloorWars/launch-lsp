...
export interface LiquidatableContract
  extends Truffle.Contract<LiquidatableInstance> {
  "new"(
    params: {
...
export interface LiquidatableInstance extends Truffle.ContractInstance {
