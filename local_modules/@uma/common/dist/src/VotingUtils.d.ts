 ...
 */
export function getVotingRoles(account: string, voting: Object, designatedVoting?: Object | undefined): {
 ...
 */
export function constructCommitment(request: Object, roundId: string, web3: Object, price: string | number | any, signingAccount: string, votingAccount: string, decimals?: string | null): Promise<{
    identifier: any;
    time: any;
    hash: any;
 ...
 * @param {String} votingAccount
 */
export function constructReveal(request: Object, roundId: string, web3: Object, signingAccount: string, votingContract: Object, votingAccount: string): Promise<{
    identifier: any;
    time: any;
    price: any;
    salt: any;
