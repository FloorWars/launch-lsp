...
export interface VotingTestContract
  extends Truffle.Contract<VotingTestInstance> {
  "new"(
...
export interface VotingTestInstance extends Truffle.ContractInstance {
