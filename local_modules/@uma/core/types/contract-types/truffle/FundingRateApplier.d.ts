...
export interface FundingRateApplierContract
  extends Truffle.Contract<FundingRateApplierInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<FundingRateApplierInstance>;
}
...
export interface FundingRateApplierInstance extends Truffle.ContractInstance {
