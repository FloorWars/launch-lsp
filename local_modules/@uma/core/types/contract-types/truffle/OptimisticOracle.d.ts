...
export interface OptimisticOracleContract
  extends Truffle.Contract<OptimisticOracleInstance> {
  "new"(
    _liveness: number | BN | string,
    _finderAddress: string,
    _timerAddress: string,
    meta?: Truffle.TransactionDetails
  ): Promise<OptimisticOracleInstance>;
}

export interface DisputePrice {
  name: "DisputePrice";
  args: {
    requester: string;
    proposer: string;
...
type AllEvents = DisputePrice | ProposePrice | RequestPrice | Settle;

export interface OptimisticOracleInstance extends Truffle.ContractInstance {
  ancillaryBytesLimit(txDetails?: Truffle.TransactionDetails): Promise<BN>;

  defaultLiveness(txDetails?: Truffle.TransactionDetails): Promise<BN>;
