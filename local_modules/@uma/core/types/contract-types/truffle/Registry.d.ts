...
export interface RegistryContract extends Truffle.Contract<RegistryInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<RegistryInstance>;
}
...
export interface NewContractRegistered {
...
export interface RegistryInstance extends Truffle.ContractInstance {
  ...
  removePartyFromContract: {
    (partyAddress: string, txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse<AllEvents>
    >;
    call(
      partyAddress: string,
