...
export interface ExpandedERC20Contract
  extends Truffle.Contract<ExpandedERC20Instance> {
  "new"(
    _tokenName: string,
    _tokenSymbol: string,
    _tokenDecimals: number | BN | string,
    meta?: Truffle.TransactionDetails
  ): Promise<ExpandedERC20Instance>;
}
...
export interface ExpandedERC20Instance extends Truffle.ContractInstance {
  /**
