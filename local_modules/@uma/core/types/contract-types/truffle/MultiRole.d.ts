...
export interface MultiRoleContract extends Truffle.Contract<MultiRoleInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<MultiRoleInstance>;
}
...
export interface MultiRoleInstance extends Truffle.ContractInstance {
  /**
