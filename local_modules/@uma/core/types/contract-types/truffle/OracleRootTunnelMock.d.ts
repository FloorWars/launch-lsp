...
export interface OracleRootTunnelMockContract
  extends Truffle.Contract<OracleRootTunnelMockInstance> {
  "new"(
    _checkpointManager: string,
    _fxRoot: string,
    _finderAddress: string,
    meta?: Truffle.TransactionDetails
  ): Promise<OracleRootTunnelMockInstance>;
}
...
export interface OracleRootTunnelMockInstance extends Truffle.ContractInstance {
