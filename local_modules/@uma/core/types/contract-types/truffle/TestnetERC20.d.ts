...
export interface TestnetERC20Contract
  extends Truffle.Contract<TestnetERC20Instance> {
  "new"(
    _name: string,
    _symbol: string,
    _tokenDecimals: number | BN | string,
    meta?: Truffle.TransactionDetails
  ): Promise<TestnetERC20Instance>;
}
...
export interface TestnetERC20Instance extends Truffle.ContractInstance {
  /**
