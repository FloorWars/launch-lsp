...
export interface FinancialContractsAdminContract
  extends Truffle.Contract<FinancialContractsAdminInstance> {
  "new"(
    meta?: Truffle.TransactionDetails
  ): Promise<FinancialContractsAdminInstance>;
}
...
export interface FinancialContractsAdminInstance
