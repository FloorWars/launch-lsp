 ...
 */
declare function getAbiTest(contractName: string, version?: string | undefined): any;
/**
 ...
 * @param {String} [version] version identifier x.y.z for the contract. Defaults to "latest".
 */
declare function getAddressTest(contractName: string, networkId: any, version?: string | undefined): any;
/**
 ...
 * @param {String} [version] version identifier x.y.z for the contract. Defaults to "latest".
 */
declare function getTruffleContractTest(contractName: string, web3?: Object | undefined, version?: string | undefined): any;
/**
 * @notice Gets the abi for an UMA contract.
 * @param {String} contractName Name of the UMA contract whose abi will be returned.
 * @param {String} [version] version identifier x.y.z for the contract. Defaults to "latest".
 */
export function getAbi(contractName: string, version?: string | undefined): any;
/**
 ...
 * @param {String} [version] version identifier x.y.z for the contract. Defaults to "latest".
 */
export function getAddress(contractName: string, networkId: any, version?: string | undefined): any;
/**
 ...
 * @param {String} [version] version identifier x.y.z for the contract. Defaults to "latest".
 */
export function getTruffleContract(contractName: string, web3?: Object | undefined, version?: string | undefined): any;
