...
export interface PerpetualLiquidatableContract
  extends Truffle.Contract<PerpetualLiquidatableInstance> {
  "new"(
    params: {
  ...
  ): Promise<PerpetualLiquidatableInstance>;
}
...
export interface PerpetualLiquidatableInstance
