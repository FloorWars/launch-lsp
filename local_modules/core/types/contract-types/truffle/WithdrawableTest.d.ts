...
export interface WithdrawableTestContract
  extends Truffle.Contract<WithdrawableTestInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<WithdrawableTestInstance>;
}
...
export interface WithdrawableTestInstance extends Truffle.ContractInstance {
  /**
