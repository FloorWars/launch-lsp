...
interface FundingRateApplierTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calculateEffectiveFundingRate(uint256,tuple,tuple)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculateEffectiveFundingRate",
    values: [
      BigNumberish,
...
export class FundingRateApplierTest extends Contract {
  ...
  interface: FundingRateApplierTestInterface;
  ...
  functions: {
    ...
    calculateEffectiveFundingRate(
      paymentPeriodSeconds: BigNumberish,
      fundingRatePerSecond: { rawValue: BigNumberish },
      currentCumulativeFundingRateMultiplier: { rawValue: BigNumberish },
      overrides?: CallOverrides
    ): Promise<[[BigNumber] & { rawValue: BigNumber }]>;

    "calculateEffectiveFundingRate(uint256,(int256),(uint256))"(
      paymentPeriodSeconds: BigNumberish,
      fundingRatePerSecond: { rawValue: BigNumberish },
      currentCumulativeFundingRateMultiplier: { rawValue: BigNumberish },
      overrides?: CallOverrides
